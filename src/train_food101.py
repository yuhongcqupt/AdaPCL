...
def get_optimizer(model, args):
    ...
    if args.mmc not in ['V']:
        text_enc_param = list(model.module.text_encoder.named_parameters()) # text encoder, classier的参数
    ...
    mm_clf_param = list(model.module.mm_classfier.parameters())  # 融合分类器的参数
