...
def run(args):
    ...
    if args.dataset in ['N24News',  'fakeddit', 'tumemo']:
...
def parse_args():
    ...
    parser.add_argument('--name', type=str, default='AdaPCL',
                        help='project name')
    parser.add_argument('--dataset', type=str, default='tumemo',
                        help='support N24Newsfakeddit/tumemo')
    ...
    parser.add_argument('--model_save_dir', type=str, default='/home/programFile/AdaPCL-Test2/results/models',
                        help='path to save model parameters.')
    parser.add_argument('--res_save_dir', type=str, default='/home/programFile/AdaPCL-Test2/results/results',
                        help='path to save training results.')
    parser.add_argument('--fig_save_dir', type=str, default='/home/programFile/AdaPCL-Test2/results/imgs',
                        help='path to save figures.')
    parser.add_argument('--logs_dir', type=str, default='/home/programFile/AdaPCL-Test2/results/logs',
